document.querySelector('#homepage-modal').innerHTML=`
    <div class="flex flex-row" >
        <div class="mobile:fixed mobile:w-full mobile:min-h-screen mobile:bg-[#000]/60">
            <div class="mobile:fixed mobile:inset-0 mobile:min-h-screen mobile:w-[15.9375rem] mobile:bg-police-blue mobile:ml-auto mobile:flex mobile:flex-col mobile:gap-[15rem]  mobile:border-dashed mobile:border-2 mobile:border-[#332b94]" >
                <div class="mobile:ml-auto pr-8 mobile:w-[11.3rem] mobile:flex mobile:flex-col   mobile:mt-[3.523125rem] border-solid border-2 border-[#344] mobile:h-[14rem]">
                ...
                <div class=" mobile:w-[12.5rem] mobile:h-[12.5rem] mobile:self-end">
