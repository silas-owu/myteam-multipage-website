...
`;$(function(){const a=$("#menu-btn"),l=$("#homepage-modal"),o=$("#close-btn");a.on("click",()=>{l.css("visibility","visible")}),o.on("click",()=>{l.css("visibility","hidden")})});document.querySelector("#landing-section").innerHTML=`
...
`;document.querySelector("#contact-section").innerHTML=`
    <div class=" contact-mobile tablet:flex tablet:flex-col tablet:h-[15rem] tablet:gap-y-4  tablet:mt-16 laptop:mt-[4.75rem]">
        <div class=" mobile:mt-[1rem] mobile:ml-[5rem]  mobile:w-[12.89rem] mobile:flex mobile:flex-col  mobile:gap-y-4 flex flex-row justify-center items-center mx-[6.0625rem] tablet:gap-[4rem] laptop:w-[57.3125rem] laptop:justify-between laptop:mx-[16.4375rem] w-[35.8125rem]">
            ...
            <button class="h-[3rem] w-[9.5625rem] font-livvic font-semibold text-[1.125rem] leading-[1.75rem] text-sacramento hover:bg-sacramento hover:cursor-pointer hover:text-[#fff] mobile:mx-auto rounded-[1.5rem] border-[0.125rem] border-solid border-sacramento" >contact us</button>
        </div>
