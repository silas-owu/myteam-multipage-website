        ...
        <div class="w-[55rem] h-[39rem] mx-auto grid grid-cols-2  bg-rapture-blue  children:border-2">
            ...
            <div class=" laptop:flex laptop:flex-col laptop:gap-y-[6.5rem] px-4 bg-midnight-green">
                ...
                <div class="laptop:flex laptop:flex-col  children:bg-midnight-green gap-y-2 children:border-2 children:border-dashed">
                    <input class="p-2 focus:outline-none h-[6rem] text-[3rem] text-rapture-blue" placeholder="Full name" type="text" id="user-name"/>
                    <input class="p-2 focus:outline-none h-[2.5rem] text-[2.5rem] text-rapture-blue" type="text" placeholder="Role" id="role-name"/>
                    <textarea class="p-2 focus:outline-none h-[4rem] text-[1.5rem] leading-2 text-dark-green"  type="text" placeholder="Experience" id="experience-input" rows="5" cols="2" ></textarea> 
                    <input class="p-2 focus:outline-none h-[2.5rem] text-[1.5rem] leading-2 text-dark-green" type="text" placeholder="Twitter link" id="twitter-update"/>
                    <input class="p-2 focus:outline-none h-[2.5rem] text-[1.5rem] leading-2 text-dark-green" type="text" placeholder="LinkedIn link" id="linkedIn-update"/>
